...
$(document).ready(function () {
  ...
  var barChartOptions = {
    ...
    series: [{
      data: [10, 25,35, 30, 25, 14, 13, 25]
    }],
    xaxis: {
      categories: ['New Deals', 'Loans Loss Reserve Estimates', 'Potential Repossessions', 'Lease Negotiations', 'Internal Appraisals', 'Desktop Appraisals', 'Collection Negotiations', 'NO Reason'],
      tickAmount: 5
    }
  }
  ...
  var pieChartOptions = {
    ...
    colors: themeColors,
    labels: ['New Deals', 'Loan Loss Reserve Estimates', 'Potential Repossessions', 'Lease Negotiations', 'Internal Appraisals','Desktop Appraisals','Collection Negotiations','No Reason'],
    series: [44, 55, 13, 43,10,20,9,1],
    legend: {
      itemMargin: {
        horizontal: 2
      },
