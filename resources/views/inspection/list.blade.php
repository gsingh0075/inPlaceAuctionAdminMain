...
@section('title','List Inspections - InPlace Auction')
        ...
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2 mt-1">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h5 class="content-header-title float-left pr-1 mb-0">Inspections</h5>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb p-0 mb-0">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="bx bx-home-alt"></i></a>
                                </li>
                                <li class="breadcrumb-item active">All Inspections
                                </li>
                            </ol>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var table = assignmentTable.DataTable( {
            ...
            pageLength : 100,
            ajax: {
                url: "{{route('getInspectionDatatable')}}",
            },
            order : [[ 7, "desc" ]],
            initComplete: function() {
                ...
                this.api().columns([9]).every(function() {
                    let column = this;
                    let select = $('<select><option value="">Inspection Status</option></select>')
                        .appendTo( $(column.header()).empty() )
                        .on( 'change', function () {
                            var val = $.fn.dataTable.util.escapeRegex(
                                $(this).val()
